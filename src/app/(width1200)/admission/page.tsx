...
export default function Home() {
  return (
    <MarginLeftRight24>
      ...
      <MarginLeftRight24>
        <p>
          本学のマイクラサーバとDiscordサーバの運営が趣旨です。両方の利用・Discord
          だけの利用、どちらの目的でご連絡いただいても構いません。
        </p>
      </MarginLeftRight24>
      ...
      <MarginLeftRight24>
        <ol>
          ...
          <li>
            筆記試験が合格だった場合、学長がDiscord面談に誘い、趣味などを訊きます(Discordサーバに趣味チャンネルがあるので何を作るか検討します)。
          </li>
          <li>
            {`面談で相当変なことをやらかさない限りはマイクラサーバに案内され、Discordサーバ上で学生権限が与えられます。` +
              `この文章をここまで読むくらいにコミュニケーションコストを割くことの大事さが分かる方であればまず大丈夫だと思います(あなたは最も難しい0次試験合格です))。`}
          </li>
        </ol>
      </MarginLeftRight24>
    </MarginLeftRight24>
