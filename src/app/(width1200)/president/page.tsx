    ...
    <div>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.uzaText}>
          ...
          <p>建学したのが、他でもない本学、インモラル大学なのです。</p>
          <p>
            インモラル大学は、騒音学部、実践ハラスメント学部、そして自称マナー講師学部からなるインモラル学領域特化大学です。ちなみに自称マナー講師学部を卒業すると自称マナー講師の称号が得られます(特に独占業務を行えるわけではありません)。
          </p>
          <p>
            コンプライアンスを破壊し、マナーを破壊し、モラルを破壊し、しっかり実践技術を身に着けて、社会に羽ばたいて行ってください。4年後を楽しみにしています。
          </p>
        </div>
      </div>
    </div>
